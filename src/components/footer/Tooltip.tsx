      ...
      <div id="SocailIcons">
        <div className="icons instaIcon">
          ...
          <div className="icon insta">
            <svg viewBox="0 0 24 24" fill="none"  width={35} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-6 h-6 text-gray-800 dark:text-white">
        ...
        <div className="icons linkedin">
          ...
          <div className="icon link">
            <svg xmlns="http://www.w3.org/2000/svg" width={35}  viewBox="0 0 24 24" style={{fill: 'rgba(0, 0, 0, 1)', transform: ''}}>
